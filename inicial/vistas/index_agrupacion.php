...
echo '<a style="margin: 10px 40px 10px 430px" href="http://54.161.158.96/blocks/inicial/vistas/create_agrupacion.php" class="btn btn-primary">Crear nueva agrupacion</a>';
...
echo '<a  style="margin-left: 100px" href="http://54.161.158.96/blocks/inicial/vistas/index_presupuestoej.php" class="btn btn-info">Regresar</a>';
echo $OUTPUT->footer();
}
?>
