...
echo '<a style="margin: 10px 40px 10px 430px" href="http://54.161.158.96/blocks/inicial/vistas/create_ejecucion.php" class="btn btn-primary">Crear nueva ejecución</a>';
$actualizateform = new QueryEjecucion();
