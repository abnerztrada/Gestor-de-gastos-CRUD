...
echo '<a style="margin: 10px 40px 10px 430px" href="http://54.161.158.96/blocks/inicial/vistas/create_presupuesto.php" class="btn btn-primary">Crear nuevo presupuesto</a>';
$actualizateform = new QueryPresupuesto();
...
echo '<a style="margin-left: 10px" href="http://54.161.158.96/blocks/inicial/vistas/index_presupuestoej.php" class="btn btn-info width: ">Regresar a presupuesto</a>';
