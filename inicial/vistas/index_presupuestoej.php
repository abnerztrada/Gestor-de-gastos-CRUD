...
echo '<a style="margin: 10px 40px 10px 430px" href="http://54.161.158.96/blocks/inicial/vistas/create_presupuestoej.php" class="btn btn-primary">Crear nuevo presupuesto</a>';
$actualizateform = new QueryPresupuestoej();
...
echo '<a style="margin-left: 10px" href="http://54.161.158.96/blocks/inicial/vistas/index_segmento.php" class="btn btn-primary width: ">Área de segmento</a>';
echo '<a style="margin-left: 10px" href="http://54.161.158.96/blocks/inicial/vistas/index_agrupacion.php" class="btn btn-primary">Área de agrupación</a>';
echo '<a style="margin-left: 10px" href="http://54.161.158.96/blocks/inicial/vistas/index_ejecucion.php" class="btn btn-primary width: ">Área de ejecuciones</a>';
echo '<a style="margin: 0px 0px 0px 10px" href="http://54.161.158.96/blocks/inicial/vistas/index_presupuesto.php" class="btn btn-primary width: ">Área de presupuesto</a>';
echo $OUTPUT->footer();
}
